...
export const Contact = () => {
  return (
    <div className='max-w-[1240px] m-auto p-4 h-screen'>
      <h1 className='text-2xl font-bold text-center p-4'>Let's work togather</h1>
      <form className='max-w-[600px] m-auto'>
        ...
        <button className='border shadow-lg p-3 w-full mt-2 bg-black text-white'>Sumit</button>
      </form>
    </div>
  )
}
